...
(function (factory, window) {
  ...
  TIMAAT.MediumService = {
    ...
    async updateCategorySets(id, categorySetIds) {
      const payload = {
        categorySetIds
      }
      return new Promise(resolve => {
        $.ajax({
          url: window.location.protocol + '//' + window.location.host + "/TIMAAT/api/medium/" + id + "/categorySets",
          type: "PUT",
          contentType: "application/json; charset=utf-8",
    ...
    async updateCategories(id, categoryIds) {
      const payload = {
        categoryIds
      }
      return new Promise(resolve => {
        $.ajax({
          url: window.location.protocol + '//' + window.location.host + "/TIMAAT/api/medium/" + id + "/categories",
          type: "PUT",
          contentType: "application/json; charset=utf-8",
          data: JSON.stringify(payload),
          dataType: "json",
    ...
    async createMediumTranscription(mediumId, engineIdentifier, modelIdentifier) {
      const createTranscriptionRequestPayload = {
        engineIdentifier,
        modelIdentifier
      }
      return new Promise((resolve, reject) => {
        $.ajax({
          url: window.location.protocol + '//' + window.location.host + "/TIMAAT/api/medium/" + mediumId + "/transcriptions",
          type: "POST",
          data: JSON.stringify(createTranscriptionRequestPayload),
          contentType: "application/json; charset=utf-8",
          dataType: "json",
          beforeSend: function (xhr) {
            xhr.setRequestHeader('Authorization', 'Bearer ' + TIMAAT.Service.token);
    ...
    async getMediumTranscriptions(mediumId) {
      return new Promise((resolve, reject) => {
        $.ajax({
          url: window.location.protocol + '//' + window.location.host + "/TIMAAT/api/medium/" + mediumId + "/transcriptions",
          type: "GET",
    ...
    async updateMediumDefaultTranscription(mediumId, transcriptionId) {
      const payload = {
        transcriptionId
      }
      ...
      return new Promise((resolve, reject) => {
        $.ajax({
          url: window.location.protocol + '//' + window.location.host + "/TIMAAT/api/medium/" + mediumId + "/transcriptions/default",
          type: "POST",
          data: JSON.stringify(payload),
          contentType: "application/json; charset=utf-8",
          beforeSend: function (xhr) {
    ...
    async deleteMediumTranscription(mediumId, transcriptionId) {
      return new Promise((resolve, reject) => {
        $.ajax({
