requirejs.config({
  ...
  paths: {
    ...
    "TIMAAT-transcriptionService": 'service/timaat.service.transcription',
    "TIMAAT-systemSettingsService": 'service/timaat.service.systemsettings',
  ...
  shim: {
    ...
    'datatables.select': {
      deps: ['datatables.net'], init: function () {
        return $.fn.dataTable;
      }
    },
