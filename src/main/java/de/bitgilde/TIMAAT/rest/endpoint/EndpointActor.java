...
public class EndpointActor {
  ...
  public DataTableInfo<Actor> getActorList(@BeanParam ActorListingQueryParameter queryParameter) {
    ...
    List<Actor> actors = actorStorage.getEntriesAsStream(queryParameter, queryParameter, queryParameter, userAccount)
                                     .collect(Collectors.toList());
    Long actorsCount = actorStorage.getNumberOfTotalEntriesRespectingAuthorization(userAccount);
    Long matchingActorsCount = actorStorage.getNumberOfMatchingEntriesRespectingAuthorization(queryParameter,
            userAccount);
  ...
  public List<SelectElement<Integer>> getActorSelectList(@BeanParam ActorListingQueryParameter queryParameter) {
    ...
    return actorStorage.getEntriesAsStream(queryParameter, queryParameter, queryParameter, userAccount)
                       .map(currentActor -> new SelectElement<>(currentActor.getId(),
                               currentActor.getDisplayName().getName())).collect(Collectors.toList());
  }
  ...
  @Secured
  @Path("{id}/select")
  public Response getActorSelect(@PathParam("id") int id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("search") String search) {
  ...
  public List<SelectElement<Integer>> getAssignableCategories(@PathParam("id") Integer id, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("search") String search) {
    Stream<ReducedEntity<Integer>> assignableCategoryStream = actorStorage.getAssignableCategoriesOfActor(id, search);
  ...
  public Response getActorDatasetsTotal() {
    ...
    Query query = TIMAATApp.emf.createEntityManager().createQuery("SELECT COUNT (a.id) FROM Actor a");
  ...
  public Response getActorTypeList() {
    ...
    List<ActorType> actorTypeList = castList(ActorType.class,
            TIMAATApp.emf.createEntityManager().createNamedQuery("ActorType.findAll").getResultList());
  ...
  @Secured
  @Path("person/list")
  public Response getPersonList(@QueryParam("draw") Integer draw, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("dir") String direction, @QueryParam("search") String search) {
    ...
    if (orderby != null) {
      if (orderby.equalsIgnoreCase("name")) {
        column = "ap.actor.displayName.name";
      }
    }
  ...
  public Response getPersonDatasetsTotal() {
    ...
    Query query = TIMAATApp.emf.createEntityManager().createQuery("SELECT COUNT (ap.id) FROM ActorPerson ap");
    long count = (long) query.getSingleResult();
    return Response.ok().entity(count).build();
  }
  ...
  public Response getPersonSelectList(@QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("search") String search) {
    // String column = "a.id";
    // if ( orderby != null ) {
    ...
    if (search != null && search.length() > 0) {
      // perform search
      query = TIMAATApp.emf.createEntityManager().createQuery(actorSearchQuery);
      query.setParameter("name", search);
      // query.setParameter("actorName", search); // birthName
    }
    else {
      query = TIMAATApp.emf.createEntityManager().createQuery(actorQuery);
    }
  ...
  public Response getCollectiveList(@QueryParam("draw") Integer draw, @QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("dir") String direction, @QueryParam("search") String search) {
    // System.out.println("EndpointActor: getActorPersonList: draw: "+draw+" start: "+start+" length: "+length+" orderby: "+orderby+" dir: "+direction+" search: "+search);
    if (draw == null) {
      draw = 0;
    }
    ...
    if (orderby != null) {
      if (orderby.equalsIgnoreCase("name")) {
        column = "ac.actor.displayName.name"; // TODO change displayName access in DB-Schema
      }
    }
  ...
  public Response getCollectiveDatasetsTotal() {
    ...
    Query query = TIMAATApp.emf.createEntityManager().createQuery("SELECT COUNT (ac.id) FROM ActorCollective ac");
    long count = (long) query.getSingleResult();
    return Response.ok().entity(count).build();
  }
  ...
  public Response getCollectiveSelectList(@QueryParam("start") Integer start, @QueryParam("length") Integer length, @QueryParam("orderby") String orderby, @QueryParam("search") String search) {
    // String column = "a.id";
    // if ( orderby != null ) {
    // 	if (orderby.equalsIgnoreCase("name")) column = "a.displayName.name"; // TODO change displayName access in DB-Schema
    // }
  ...
  public Response getAddressTypeList() {
    ...
    List<AddressType> addressTypeList = castList(AddressType.class,
            TIMAATApp.emf.createEntityManager().createNamedQuery("AddressType.findAll").getResultList());
  ...
  public Response getEmailAddressTypeList() {
    ...
    List<EmailAddressType> emailAddressTypeList = castList(EmailAddressType.class,
            TIMAATApp.emf.createEntityManager().createNamedQuery("EmailAddressType.findAll").getResultList());
  ...
  public Response getPhoneNumberTypeList() {
    ...
    List<PhoneNumberType> emailAddressTypeList = castList(PhoneNumberType.class,
            TIMAATApp.emf.createEntityManager().createNamedQuery("PhoneNumberType.findAll").getResultList());
    return Response.ok().entity(emailAddressTypeList).build();
  }
  ...
  public Response getActorRoleInMediumList(@PathParam("actorId") int actorId, @PathParam("roleId") int roleId) {
    ...
    Query query = entityManager.createQuery(sql).setParameter("actorId", actorId).setParameter("roleId", roleId);
    // Actor actor = entityManager.find(Actor.class, actorId);
  ...
  @Secured
  @Path("sex/selectList")
  public Response getSexSelectList(@QueryParam("page") Integer page, @QueryParam("search") String search, @QueryParam("language") String languageCode) {
    ...
    for (SexTranslation sexTranslation : sexTranslationList) {
      sexSelectList.add(new SelectElement<Integer>(sexTranslation.getSex().getId(), sexTranslation.getType()));
    }
  ...
  public Response createActor(@PathParam("id") int id, String jsonData) {
    ...
    UserLogManager.getLogger()
                  .addLogEntry(newActor.getCreatedByUserAccount().getId(), UserLogManager.LogEvents.ACTORCREATED);
  ...
  public Response updateActor(@PathParam("id") int id, String jsonData) {
    ...
    // update actor
    if (updatedActor.getIsFictional() != null) {
      actor.setIsFictional(updatedActor.getIsFictional());
    }
    if (updatedActor.getDisplayName() != null) {
      actor.setDisplayName(updatedActor.getDisplayName());
    }
    ...
    if (containerRequestContext.getProperty("TIMAAT.userID") != null) {
      actor.setLastEditedByUserAccount(
              (entityManager.find(UserAccount.class, containerRequestContext.getProperty("TIMAAT.userID"))));
    }
    else {
      // DEBUG do nothing - production system should abort with internal server error
  ...
  public Response updatePerson(@PathParam("id") int id, String jsonData) {
    ...
    if (containerRequestContext.getProperty("TIMAAT.userID") != null) {
      person.getActor().setLastEditedByUserAccount(
              (entityManager.find(UserAccount.class, containerRequestContext.getProperty("TIMAAT.userID"))));
    }
    else {
      // DEBUG do nothing - production system should abort with internal server error
  ...
  public Response updateActorPersonTranslation(@PathParam("personId") int personId, @PathParam("id") int id, String jsonData) {
    ...
    if (updatedTranslation.getSpecialFeatures() != null) {
      personTranslation.setSpecialFeatures(updatedTranslation.getSpecialFeatures());
    }
  ...
  public Response updateCollective(@PathParam("id") int id, String jsonData) {
    ...
    if (containerRequestContext.getProperty("TIMAAT.userID") != null) {
      collective.getActor().setLastEditedByUserAccount(
              (entityManager.find(UserAccount.class, containerRequestContext.getProperty("TIMAAT.userID"))));
    }
    else {
      // DEBUG do nothing - production system should abort with internal server error
  ...
  public Response deleteName(@PathParam("id") int id) {
    ...
    // add log entry
    UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"),
            UserLogManager.LogEvents.ACTORNAMEDELETED);
    return Response.ok().build();
  }
  ...
  public Response updateActorHasAddress(@PathParam("actorId") int actorId, @PathParam("addressId") int addressId, String jsonData) {
    ...
    if (updatedActorHasAddress == null) {
      return Response.notModified().build();
    }
  ...
  public Response updateEmailAddress(@PathParam("id") int id, String jsonData) {
    ...
    // update emailAddress
    if (updatedEmailAddress.getEmail() != null) {
      emailAddress.setEmail(updatedEmailAddress.getEmail());
    }
    ...
    // add log entry
    UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"),
            UserLogManager.LogEvents.EMAILEDITED);
    return Response.ok().entity(emailAddress).build();
  }
  ...
  public Response updateActorHasEmailAddress(@PathParam("actorId") int actorId, @PathParam("emailAddressId") int emailAddressId, String jsonData) {
    ...
    if (updatedActorHasEmailAddress == null) {
      return Response.notModified().build();
    }
  ...
  public Response deleteEmailAddress(@PathParam("id") int id) {
    ...
    // add log entry
    UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"),
            UserLogManager.LogEvents.EMAILDELETED);
    return Response.ok().build();
  }
  ...
  public Response updatePhoneNumber(@PathParam("id") int id, String jsonData) {
    ...
    // update phoneNumber
    if (updatedPhoneNumber.getPhoneNumber() != null) {
  ...
  public Response updateActorHasPhoneNumber(@PathParam("actorId") int actorId, @PathParam("phoneNumberId") int phoneNumberId, String jsonData) {
    ...
    if (updatedActorHasPhoneNumber == null) {
      return Response.notModified().build();
    }
  ...
  @Secured
  public Response addPersonIsMemberOfCollective(@PathParam("actorId") int actorId, @PathParam("collectiveId") int collectiveId) throws IOException {
  ...
  @Path("{actorId}/personIsMemberOfCollective/{collectiveId}")
  @Secured
  public Response updatePersonIsMemberOfCollective(@PathParam("actorId") int actorId, @PathParam("collectiveId") int collectiveId, String jsonData) {
    ...
    ActorPerson person = entityManager.find(ActorPerson.class, actorId);
    ActorCollective collective = entityManager.find(ActorCollective.class, collectiveId);
    if (person == null || collective == null) {
      return Response.status(Status.NOT_FOUND).build();
    }

    ActorPersonIsMemberOfActorCollective apimoacKey = new ActorPersonIsMemberOfActorCollective(person, collective);
    ActorPersonIsMemberOfActorCollective apimoac = entityManager.find(ActorPersonIsMemberOfActorCollective.class,
            apimoacKey.getId());
    // parse JSON data
    try {
      updatedActorPersonIsMemberOfActorCollective = mapper.readValue(jsonData,
              ActorPersonIsMemberOfActorCollective.class);
    } catch (IOException e) {
      e.printStackTrace();
      return Response.status(Status.BAD_REQUEST).build();
    }
    if (updatedActorPersonIsMemberOfActorCollective == null) {
      return Response.notModified().build();
    }
  ...
  @Secured
  public Response deletePersonIsMemberOfCollective(@PathParam("personId") int personId, @PathParam("collectiveId") int collectiveId) {
  ...
  @Secured
  public Response addMembershipDetail(@PathParam("personId") int personId, @PathParam("collectiveId") int collectiveId, @PathParam("id") int id, String jsonData) {
  ...
  @Secured
  public Response updateMembershipDetail(@PathParam("id") int id, String jsonData) {
  ...
  public Response updateCitizenship(@PathParam("id") int id, String jsonData) {
    ...
    // add log entry
    UserLogManager.getLogger().addLogEntry((int) containerRequestContext.getProperty("TIMAAT.userID"),
            UserLogManager.LogEvents.CITIZENSHIPEDITED);
    return Response.ok().entity(citizenship).build();
  }
  ...
  public Response updateCitizenshipTranslation(@PathParam("id") int id, @PathParam("languageId") int languageId, String jsonData) {
    ...
    if (citizenshipTranslation == null) {
      return Response.status(Status.NOT_FOUND).build();
    }
    ...
    if (updatedCitizenshipTranslation == null) {
      return Response.notModified().build();
    }
    // update citizenship
    if (updatedCitizenshipTranslation.getName() != null) {
      citizenshipTranslation.setName(updatedCitizenshipTranslation.getName());
    }
  ...
  @Produces("image/png")
  public Response getProfileImage(@PathParam("imageId") int imageId, @QueryParam("token") String fileToken) {
    // verify token
    if (fileToken == null) {
    ...
    // }
    if (!profileImage.exists() || !profileImage.canRead()) {
      profileImage = new File(servletContext.getRealPath("img/preview-placeholder.png"));
    }
  ...
  @Secured
  public Response addExistingTag(@PathParam("actorId") int actorId, @PathParam("tagId") int tagId) {
  ...
  @Path("{actorId}/tag/{tagId}")
  @Secured
  public Response removeTag(@PathParam("actorId") int actorId, @PathParam("tagId") int tagId) {
